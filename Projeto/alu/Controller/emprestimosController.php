<?php
    ...
    class EmprestimoController{
        ...
        public function verificarPendencia($idUsuario){
            $connection = new Connection();
            $conn = $connection->getConnection();
            $dao = new EmprestimoDao();
            $res = $dao->verificarPendencia($conn, $idUsuario);
            return $res;

        }

        public function solicitarEmprestimo($idUsuario, $livros){
            $connection = new Connection();
            $conn = $connection->getConnection();
            $dao = new EmprestimoDao();
            $res = $dao->solicitarEmprestimo($conn, $idUsuario, $livros);
        }
        ...
        public function listar($idUsuario){
            ...
            $conn = $connection->getConnection();
            $dao = new EmprestimoDao();
            $res = $dao->listarEmprestimos($conn, $idUsuario);
            return $res;
