...
<body>
    <nav class="navbar navbar-fixed-top site-header sticky-top py-1 navbar-expand-lg navbar-dark bg-gradient-primary">
        <input type='button' class="btn btn-primary font-weigth-bold" value='&#8626' onclick='history.back()' />
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSite">
                <ul class="navbar-nav mr-auto font-weight-bold" style="font-size: 1.3rem;">
                    ...
                    <li class="nav-item">
                        <a href="emprestimos.php" class="nav-link">Meus Empréstimos</a>
                    </li>
                </ul>
                <h3></h3>
                <ul class="navbar-nav ml-auto" style="font-size: 1.1rem;">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a href="./detalheAluno.php?cod=<?=$idUsuario?>" class="dropdown-item">Ver Perfil</a>
