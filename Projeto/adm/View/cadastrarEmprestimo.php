...
$idBibliotecario = $_SESSION['idUsuario'];
...
<body style="background-image: url('../img/sug.jpg');">
            ...
            <form action="" class="" method="post">
                <div class="form-group table-primary row container">
                    <div class="col-md-2">
                        ...
                        <input type="text" class="form-control" id="campoNome" name="idUsuario" placeholder="Código" required>
                    </div>
                    <div class="col-md-8">
    ...
    <!-- Optional JavaScript -->
    <script src="../scripts/scriptCadastrarEmprestimo.js"></script>
