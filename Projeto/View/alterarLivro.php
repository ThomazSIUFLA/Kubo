...
<form method="POST" action="../Controller/c_alterarLivro.php" class="container">
    <div class="form-group">
        <label for="exampleInputEmail1" >Código Biblioteca</label>
        <input type="number"  name="codLivro"  value="<?= $cod ?>" hidden>
    ...
    <div class="form-group">
        ...
        <input type="number" max-lenght="4" name="anoPublic" min="1900" max="2020" class="form-control col-md-5 mb-4" placeholder="<?php echo $reg['anoPublic'] ?>"value="<?php echo $reg['anoPublic'] ?>">
