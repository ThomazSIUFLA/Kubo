...
<div class="card container center col-md-4" style="background: #007bff linear-gradient(180deg, #268fff, #007bff) repeat-x">
  ...
  <div class="card-body">
    <a href="./excluirEmprestimo.php?cod=<?php echo $reg['idUsuario']?>" class="card-link btn btn-outline-danger">Excluir</a>
    <a class="card-link btn btn-outline-success" href="./alterarEmprestimo.php?cod=<?php echo $reg['idUsuario'] ?>">Alterar</a>
