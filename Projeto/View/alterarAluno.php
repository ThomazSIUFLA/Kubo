...
$serie = $serieTurma[0];
$turma = $serieTurma[1];
$nasc = date("d/m/Y", strtotime($reg['nascimento']));
    ...
    <form method="POST" action="" class="container table-primary">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-3">
                ...
                <input type="text" name="nascimento" class="form-control" value="<?= $nasc ?>" required>
            </div>
        </div>
...
if($_POST){
    ...
    $control = new AlunosController();
    $control->alterarAluno($idUsuario, $idAluno, $nome, $telefone, $email, 
    $endereco, $serie, $turma, $nasc, $nomeResp, $telResp);
    ?>
    <script>
